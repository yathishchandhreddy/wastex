-- ==============================================================================
-- Migration: 20260918000000_init_wastex_schema.sql
-- WasteX AI - Comprehensive Schema, Constraints, Indexes, and RLS Policies
-- ==============================================================================
...
-- 12. STRICT RLS POLICIES (NO USING(true) / WITH CHECK(true) for unrestricted access)
